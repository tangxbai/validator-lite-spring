 ...
 */
public class ValidatorLiteBean implements ApplicationListener<ContextRefreshedEvent>, BeanDefinitionRegistryPostProcessor {
	
	private ContextConfigurion configurion = new ContextConfigurion();
	...
	public void onApplicationEvent( ContextRefreshedEvent event ) {
		...
		com.viiyue.plugins.validator.Validator.configuration( configurion );
